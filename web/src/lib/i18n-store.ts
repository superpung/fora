...
const zh: Dict = {
  ...
  "reminders.enable": "开启提醒",
  "reminders.on": "已开启",
  "reminders.off": "已关闭",
  "reminders.disable": "关闭提醒",
  "reminders.lead": "提前提醒",
  "reminders.min": "{n} 分钟",
  "reminders.dayStart": "每日开始提醒",
  "reminders.blocked": "浏览器已阻止通知，请在系统设置中允许",
  "reminders.unsupported": "当前浏览器不支持通知",
  "reminders.hint": "为你收藏的报告发送本地通知。仅在本设备安排，不上传服务器。iOS 需将本应用添加到主屏幕后使用；关闭浏览器时的后台提醒取决于系统支持。",
  "reminders.upcoming": "已安排 {n} 场",
...
const en: Dict = {
  ...
  "reminders.blocked": "Notifications are blocked — allow them in your browser settings.",
  "reminders.unsupported": "This browser doesn't support notifications.",
  "reminders.hint": "Get a local notification before your starred talks. Scheduled on this device only, never uploaded. On iOS, add the app to your Home Screen first; background delivery while the browser is closed depends on OS support.",
  "reminders.upcoming": "{n} scheduled",
