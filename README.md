...
- 🗓️ **The whole program** — keynotes, parallel sessions, and speakers, fully bilingual (中文 / English), with a time view that shows what's running in parallel — and what's on right now.
- ⭐ **Your own agenda** — star the talks, sessions, and speakers you care about, and get a focused, filterable schedule of just your picks.
...
- 🔍 **People** — search speakers and browse each conference's committee and organizers.
