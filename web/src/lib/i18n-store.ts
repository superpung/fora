...
const zh: Dict = {
  ...
  "topics.mapAria": "主题地图：方块面积表示报告数量，按数量从多到少排列",
  "topics.tileAriaOne": "{topic}，{n} 场报告",
  "topics.tileAria": "{topic}，{n} 场报告",
  "topics.related": "共现主题",
  "topics.groupBy": "分组",
...
const en: Dict = {
  ...
  "topics.mapAria": "Topic map: tile area is the talk count, largest first",
  "topics.tileAriaOne": "{topic}, {n} talk",
  "topics.tileAria": "{topic}, {n} talks",
